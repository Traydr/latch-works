...
export function PdfDocument({ title, ...documentProps }: PdfDocumentProps): JSX.Element {
  const { containerRef, error, pageCount, scrollContainerRef } = usePdfDocument(documentProps);
