...
open-sourcing test audit on 2026-07-27. Every open plan is written for an implementation agent and
...
Plan 037 is the only ready-to-execute item: all three of its dependencies landed. Plans 025 and 040
are blocked on environment access rather than on code (see below); neither blocks 037.
