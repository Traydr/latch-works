...
| [046](046-inject-pane-view-module-state.md) | Remove test-only exports by injecting module state | P2 | M | — | DONE |
| [047](047-neutralize-test-fixtures.md) | Neutralize repository-visible test fixtures | P3 | S | — | DONE |
