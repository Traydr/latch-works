...
>
> **Drift check (run first)**: `git diff --stat 027d48a..HEAD -- apps/pane-view/src/server/management/cleanup-worker.ts apps/pane-view/src/server/management/*.test.ts apps/pane-view/src/server/db/schema.ts`
