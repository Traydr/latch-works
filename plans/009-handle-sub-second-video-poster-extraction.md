...
>
> **Drift check (run first)**: `git diff --stat 027d48a..HEAD -- packages/media-derivatives/src/video.ts packages/media-derivatives/src/generate.test.ts packages/media-derivatives/src/video.test.ts packages/media-derivatives/src/descriptor.ts`
